          ...
          <div className='flex items-center space-x-4'>
            {[1, 2, 3].map(stepNumber => (
              <div key={stepNumber} className='flex items-center'>
                <motion.div
                  animate={{
                    backgroundColor: stepNumber <= step ? 'var(--color-primary)' : 'var(--color-muted)',
                    color: stepNumber <= step ? 'var(--color-primary-foreground)' : 'var(--color-muted-foreground)',
                ...
                {stepNumber < 3 && (
                  <div className='relative mx-4 h-1 w-16 overflow-hidden rounded bg-muted'>
                    <motion.div
                      className='absolute inset-y-0 left-0 rounded bg-primary'
                      initial={{ width: '0%' }}
                      animate={{ width: stepNumber < step ? '100%' : '0%' }}
